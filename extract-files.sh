...
adb pull /system/app/Finsky.apk ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/Finsky.apk
...
adb pull /system/app/Vending.apk ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/Vending.apk
